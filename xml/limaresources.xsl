...
<xsl:stylesheet
	...
	<!-- icons for threads -->
	<xsl:variable name="icon_important"><xsl:text>https://www.lima-city.de/images/layout/icons/flag_green.png</xsl:text></xsl:variable>
	<xsl:variable name="icon_fixed"><xsl:text>https://www.lima-city.de/images/layout/icons/lightning.png</xsl:text></xsl:variable>
	<xsl:variable name="icon_closed"><xsl:text>https://www.lima-city.de/images/layout/icons/lock.png</xsl:text></xsl:variable>

	<xsl:variable name="star_green"><xsl:text>https://www.lima-city.de/images/layout/stars/star_green.png</xsl:text></xsl:variable>
	<xsl:variable name="star_yellow"><xsl:text>https://www.lima-city.de/images/layout/stars/star_yellow.png</xsl:text></xsl:variable>
	<xsl:variable name="star_orange"><xsl:text>https://www.lima-city.de/images/layout/stars/star_orange.png</xsl:text></xsl:variable>
	<xsl:variable name="star_red"><xsl:text>https://www.lima-city.de/images/layout/stars/star_red.png</xsl:text></xsl:variable>

	<xsl:variable name="star_m"><xsl:text>https://www.lima-city.de/images/star_m.png</xsl:text></xsl:variable>
	<xsl:variable name="star_k"><xsl:text>https://www.lima-city.de/images/star_k.png</xsl:text></xsl:variable>
